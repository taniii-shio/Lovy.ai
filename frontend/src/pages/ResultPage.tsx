    ...
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white shadow-sm px-6 py-4 flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-gray-800">Lovy.ai Result</h1>
        </div>

        {/* Scrollable Content */}
        <div
          id="share-content"
          className="bg-gradient-to-br from-purple-50 to-pink-50  shadow-lg p-8 space-y-8 pb-32"
        >
          {/* Title */}
