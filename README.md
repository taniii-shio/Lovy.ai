...
Love & Personality Diagnosis Platform - MBTI × Love Type 16 による256通りの診断サービス

## 概要

Lovy.aiは、MBTI（16タイプ）とLove Type 16（16タイプ）を組み合わせた256通りの恋愛・性格診断プラットフォームです。

### 診断結果の内容

1. **モテ度スコア** - あなたの恋愛市場での魅力度を数値化
2. **性格分析** - MBTI × Love Typeの組み合わせによる詳細な性格テキスト
3. **相性診断** - あなたに最適な相手のTop 3
4. **愛着表現ランキング** - 5つの愛の言語の優先順位
